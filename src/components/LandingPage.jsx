...
function LandingPage() {
  return (
    <div data-scroll data-scroll-speed="-0.6" className="w-full h-screen bg-[#f1f1f1] pt-1">
      <div className="text-black textstructure mt-52 px-16">
        {[
          "We Create",
          "Eye-Opening",
          "Presentations"
          ...
          return (
            <div className="masker">
              <div className="w-fit flex items-end overflow-hidden">
                {index===1 && (
                  <div>
                    <motion.div initial={{width: "0"}} animate={{width: "9vw"}} transition={{ease: [.86,0,.07,.995], duration: [1.2]}} className="w-[10vw] rounded-md h-[5.8vw] -top-[0.2vw] relative">
                      <img className='h-full rounded-xl relative' src='https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg'></img>
                    </motion.div>
                  </div>
                  )}
              <h1 className="flex items-center uppercase text-[7.5vw] h-full leading-[7vw] tracking-tighter font-['Oswald'] font-bold">{item}</h1>
              </div>
            </div>
          )
        })}
      </div>
      <div class="scale-50 origin-top-right md:scale-100 absolute top-100 lg:top-150 -mt-[20vw] right-0">
			<a href="https://www.awwwards.com/sites/ochi-design" target="_blank">
				<svg width="60" height="202">
      ...
      <div className="border-t-2 border-zinc-800 mt-32 flex justify-between items-center py-4 px-14">
        {[
          "For public and private companies",
          "From the first pitch to IPO"
          ].map((item,index)=>(<p className="text-zinc-900 text-[1vw] font-['Neue_Montreal'] font-medium tracking-tighter leading-none">{item}</p>))}
        <div className="start flex items-center gap-1">
          <button className='flex gap-3 font-medium text-[1.1vw] uppercase font-["Neue_Montreal"] text-black px-5 py-2 border-[1px] border-black rounded-full transition ease-linear hover:bg-black delay-75 hover:text-white'>Start the project<span className='mt-1 rotate-[45deg]'><FaArrowUp /></span></button>
        </div>
      </div>      
    </div>
  );
